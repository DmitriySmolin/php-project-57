<?php $__env->startSection('content'); ?>
    <div class="grid col-span-full">
        ...
        <?php echo e(Form::open(['route' => 'task_statuses.store', 'class' => 'w-50'])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-name','data' => ['label' => ''.e(__('views.task_status.create.name')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => ''.e(__('views.task_status.create.name')).'']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.submit-button','data' => ['caption' => ''.e(__('views.task_status.create.button')).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['caption' => ''.e(__('views.task_status.create.button')).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
